...
namespace AccessibleBank.Controllers
{
    ...
    public class TransactionsController : ControllerBase
    {
        ...
        [HttpGet("export")]
        public async Task<IActionResult> Export([FromQuery] string format = "csv", [FromQuery] string? category = null, [FromQuery] DateTime? dateFrom = null, [FromQuery] DateTime? dateTo = null)
        {
